...
opts_parser.add_option(
    '-c', '--color', default = True, action = "store_true",
    help = "Print the MOTD with color.",
)
opts_parser.add_option(
    '-w', '--warn', default = True, action = "store_true",
    help = (
...
# Get Kernel Version
try:
    kernel_version = exec_cmd('uname -r')[0].strip()
    info_list.append(('Kernel', colorize(kernel_version, TEXT_PRIMARY)))
except:
    pass
